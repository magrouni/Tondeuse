...
public class Position {
	...
	public void turnRightDirection() {
		direction = direction.getDroitDirection();
	}
	
	public void turnLeftDirection() {
		direction = direction.getGaucheDirection();
	}
	
	public void enAvantIfPossible(final JardinLimit limit) {
		switch(direction) {
			case North :
				if (y < limit.getY()) { y += 1; }
				break;
...
/*	public boolean isValidPosition(final JardinLimit limit) {
